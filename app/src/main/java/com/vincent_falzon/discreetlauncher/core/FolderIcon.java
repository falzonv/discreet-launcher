...
public class FolderIcon extends Drawable
{
	...
	public FolderIcon(Context context, int applications_number)
	{
		...
		Drawable folderIcon = ResourcesCompat.getDrawable(context.getResources(), R.drawable.notification_icon, null) ;
		if(folderIcon != null)
			{
	...
	public void draw(Canvas canvas)
	{
		...
		canvas.drawText(number, 24 * density, 39 * density, paint);
	}
